---
name: usage-gauge
description: Give a compact fuzzy forecast of task resource intensity, warn before expensive execution, and provide a tiny post-session audit only when useful. Use for /tokens, usage-gauge requests, or clear high-cost work.
---
